...
$this->addExternalCss(SITE_TEMPLATE_PATH."/components/bitrix/catalog.section/poselki/style.css");
...
<?if ($showLazyLoad) {?><div class="w-100 text-center buttons mt-3 mb-0" data-use="show-more-<?=$navParams['NavNum']?>"><a class="button"><?=$arParams['MESS_BTN_LAZY_LOAD']?></a></div><?}?>
<?
