...
<div class="catalog-section" data-entity="<?=$containerName?>">
	...
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		$generalParams = [
			...
			'COLORS_ARRAY' => $arParams['COLORS_ARRAY'],
			'UID' => $arParams['UID'],
		];
...
<?if ($showLazyLoad) {?><div class="w-100 text-center buttons mt-1 mb-0" data-use="show-more-<?=$navParams['NavNum']?>"><a class="button"><?=$arParams['MESS_BTN_LAZY_LOAD']?></a></div><?}?>
<div class="w-100 text-center buttons mt-3 mb-4"><a class="button frbtn" href="#plan">Генплан</a><?if($arParams['MESS_BTN_COMPARE'] != "") {?><a class="button frbtn" href="/zemelnye-uchastki-v-moskovskoy-oblasti/<?=$arParams['MESS_BTN_COMPARE']?>/<?if($_GET["uid"] != ""){ echo "?uid=".$_GET["uid"]; }?>">Поиск<i class="mso mi_rarr right"></i></a><?}?></div>
<?
